package it.ppro.prova.repository;

import it.ppro.prova.ProvaApp;
import it.ppro.prova.config.Constants;
import it.ppro.prova.config.audit.AuditEventConverter;
import it.ppro.prova.domain.PersistentAuditEvent;
...
import static it.ppro.prova.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
