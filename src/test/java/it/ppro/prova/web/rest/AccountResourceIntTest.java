package it.ppro.prova.web.rest;

import it.ppro.prova.config.Constants;
import it.ppro.prova.ProvaApp;
import it.ppro.prova.domain.Authority;
import it.ppro.prova.domain.User;
import it.ppro.prova.repository.AuthorityRepository;
import it.ppro.prova.repository.UserRepository;
import it.ppro.prova.security.AuthoritiesConstants;
import it.ppro.prova.service.MailService;
import it.ppro.prova.service.dto.UserDTO;
import it.ppro.prova.service.dto.PasswordChangeDTO;
import it.ppro.prova.web.rest.errors.ExceptionTranslator;
import it.ppro.prova.web.rest.vm.KeyAndPasswordVM;
import it.ppro.prova.web.rest.vm.ManagedUserVM;
import it.ppro.prova.service.UserService;
...
@SpringBootTest(classes = ProvaApp.class)
